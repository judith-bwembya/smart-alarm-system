...
//CODE BY JUDITH BWEMBYA
//STUDENT AT DMI ST EUGENE UNIVERSITY, CHIBOMBO, ZAMBIA
...
LiquidCrystal_I2C lcd (0x27 , 2, 1, 0, 4, 5, 6, 7, 3, POSITIVE);// Creates an LC object. Parameters: (rs, enable, d4, d5, d6, d7) 
